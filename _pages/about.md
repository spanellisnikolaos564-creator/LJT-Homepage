...
The full list is also available on the [Publications page]({{ base_path }}/publications/).
...
2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. "On the Perception Bottleneck of VLMs for Chart Understanding." Arxiv, 2025. (First author; code: Vision4Chart on GitHub)
3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. "On the Universal Truthfulness Hyperplane Inside LLMs." EMNLP 2024. (First author; code: Universal_Truthfulness_Hyperplane on GitHub)
